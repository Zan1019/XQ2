...
namespace XQ2
{
    class Program
    {
        ...
        static public void Choise(Point destination)
        {
            ...
            //展示位置
            Console.WriteLine("Please input the destination (x,y).");
            Point distination = (GetInputPoint());

            //判断是否错误，错误的话要求重新输入
            while (!pie[a].ValidMoves(distination))
            {
                Console.WriteLine("Please input the right destination.");
        ...
        {
            //Console.WriteLine("Please input point(x,y):");
            String str = Console.ReadLine();
            //
            while (!Judge(str))
            {
                Console.WriteLine("Your input is wrong, please input point like 1,1 or 1 2.");
                Console.WriteLine("Please input point(x,y):");
        ...
        static void Main(string[] args)
        {
            ...
            while (pie[ChangeTopie(7)].GetGameBoardposition() != 0 && pie[ChangeTopie(-7)].GetGameBoardposition() != 0)
            {
                ...
                //获得用户输入
                Console.WriteLine("Please choose pieces (x,y).");
